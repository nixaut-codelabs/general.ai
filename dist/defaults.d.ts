import type { GeneralAIContextConfig, GeneralAIIntelligenceLevel, GeneralAILimits, GeneralAIParallelConfig, GeneralAIPreset, GeneralAIPromptOverrides, GeneralAISafetyConfig, GeneralAIThinkingConfig, PromptSectionKey } from "./types.js";
...
export declare const DEFAULT_PRESET: GeneralAIPreset;
export declare const DEFAULT_INTELLIGENCE: GeneralAIIntelligenceLevel;
...
export declare const PRESET_NAMES: GeneralAIPreset[];
